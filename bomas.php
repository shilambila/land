...
<body data-page="bomas" class="bomas-page">
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        ...
                        <div class="card-footer bg-white py-2">
                            <small class="text-muted">
                                ...
                                <?php echo count($bomas) - count($bomas_for_map); ?> bomas missing coordinates.
                            </small>
                        </div>
                    </div>
    ...
    <script>
        ...
        function initMap() {
            // Create main map
            map = new google.maps.Map(document.getElementById('bomas-map'), {
            ...
            if (boma.center_lat && boma.center_lng) {
                ...
                setTimeout(() => {
                    new google.maps.Map(document.getElementById('view-map'), {
                        center: { lat: parseFloat(boma.center_lat), lng: parseFloat(boma.center_lng) },
                        zoom: 12,
